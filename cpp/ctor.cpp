...
class OnlyCopy {
    class OnlyCopy {
       public:
        OnlyCopy(string member) : member_(member) {
            cout << "init only copy\n";
        }
    ...
    class OnlyMove {
       public:
        OnlyMove(string member) : member_(member) {
            cout << "init only move\n";
        }
        ...
        class HaveBoth {
            class HaveBoth {
               public:
                HaveBoth(string member) : member_(member) {
                    cout << "init both\n";
                }
            ...
            class UseCopy {
                ...
                class UseMove {
                    ...
                    class CopyMoves {
                       public:
                        void call_copy(const T& obj) {
                            T copied(std::move(obj));
                        }
                        void call_move(NOT_USED T&& obj) {}
                    };
                    ...
                    int main() {
                        ...
                        // error: rvalue reference to type 'OnlyCopy' cannot
                        // bind to lvalue of type 'OnlyCopy'
                        ...
                        // error: rvalue reference to type 'OnlyMove' cannot
                        // bind to lvalue of type 'OnlyMove'
